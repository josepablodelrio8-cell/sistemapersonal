...
<div class="page-header animated">
    <div>
        ...
        <div style="font-size:.8rem; color:var(--text-muted); margin-top:3px;">Completa los datos del nuevo registro</div>
    </div>
...
<div class="card form-card animated-d1">
    <form method="POST" action="index.php?action=store" id="createForm">
        <div class="form-row">
